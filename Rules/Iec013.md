# Iec013 - Field type needs correct DataType attribute

**Severity:** ![Error](../images/Error.png) Error

The `[DataType]` attribute of fields attributed with `[Local]`, `[Output]`, ` [Input]` , `[InOut]`, `[InputPort]` and `[OutputPort]` has to fit to the parameter type.
