...
* An example that disables the rule [CSADD001](Rules/CSADD001.md) in all .cs files (on and beneath the level of the EditorConfig file) would be: 
  ...
  # sets CSADD001 severity to none (possible severities:
...
* User Types
  ...
  * `[String]`
    * [CSADD026](Rules/CSADD026.md) [CSADD028](Rules/CSADD028.md) 
  * `[Structure]`
    * [CSADD027](Rules/CSADD027.md)
  * `[Array]`
    * [CSADD025](Rules/CSADD025.md)
...
* [CSADD004](Rules/CSADD004.md) [CSADD018](Rules/CSADD018.md) [CSADD040](Rules/CSADD040.md) [CSADD042](Rules/CSADD042.md)



### Miscellaneous

[CSADD001](Rules/CSADD001.md) [CSADD043](Rules/CSADD043.md) [CSADD044](Rules/CSADD044.md) [CSADD045](Rules/CSADD045.md)
